  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="text-xl font-bold mb-4" style={{ color: '#8e67ea' }}>Nahlásit problém</h2>
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            <label htmlFor="message" className="block text-sm font-medium text-gray-700">Popis problému</label>
            <textarea
              id="message"
              name="message"
              onChange={handleChange}
